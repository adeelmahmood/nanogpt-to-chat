...
from chat import decode_with_special_tokens, get_special_tokens, render_conversation, render_conversation

def sft_loader(model, dataset, batch_size, tokenizer, device, ddp_rank=0, ddp_world_size=1):
...
if __name__ == "__main__":
    ...
    sft_loader_obj = sft_loader(model=None, dataset=task, batch_size=1, tokenizer=tokenizer, device='cpu')
